...
(function smart404PdpRebuild() {
  ...
  (async () => {
    ...
    const triggerUrl = `https://285361-249darkllama-stage.adobeioruntime.net/api/v1/web/accs-discovery/prepublish-pdp?org=jogosset&site=hivi-b2b-demo&path=${encodeURIComponent(lc)}`;
